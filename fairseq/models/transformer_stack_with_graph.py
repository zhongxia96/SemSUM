...
@register_model('transformer_stack_with_graph')
...
@register_model_architecture('transformer_stack_with_graph', 'transformer_stack_with_graph')
...
@register_model_architecture('transformer_stack_with_graph', 'transformer_stack_with_graph_gigaword')
...
@register_model_architecture('transformer_stack_with_graph', 'transformer_stack_with_graph_gigaword_big')
def transformer_stack_with_graph_gigaword_big(args):
    args.encoder_embed_dim = getattr(args, 'encoder_embed_dim', 512)
    args.encoder_ffn_embed_dim = getattr(args, 'encoder_ffn_embed_dim', 2048)
    args.encoder_attention_heads = getattr(args, 'encoder_attention_heads', 8)
...
@register_model_architecture('transformer_stack_with_graph', 'transformer_stack_with_graph_gigaword_big2')
def transformer_stack_with_graph_gigaword_big2(args):
    args.encoder_embed_dim = getattr(args, 'encoder_embed_dim', 512)
    args.encoder_ffn_embed_dim = getattr(args, 'encoder_ffn_embed_dim', 2048)
    args.encoder_attention_heads = getattr(args, 'encoder_attention_heads', 8)
    args.graph_attention_heads = getattr(args, 'graph_attention_heads', 4)
...
@register_model_architecture('transformer_stack_with_graph', 'transformer_stack_with_graph_gigaword_big3')
...
@register_model_architecture('transformer_stack_with_graph', 'transformer_stack_with_graph_gigaword_big4')
def transformer_stack_with_graph_gigaword_big2(args):
    args.encoder_embed_dim = getattr(args, 'encoder_embed_dim', 512)
    args.encoder_ffn_embed_dim = getattr(args, 'encoder_ffn_embed_dim', 2048)
    args.encoder_attention_heads = getattr(args, 'encoder_attention_heads', 8)
